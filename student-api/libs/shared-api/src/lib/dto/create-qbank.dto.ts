import type { CourseInterface, QBankFlagsInterface, QBankSubjectInterface, SyllabusInterface, TestCategoryInterface, TestFlagsInterface, TestInterface, TestQuestionInterface, UserKeyInterface } from '@application/api-interfaces';
import {
  IsArray,
  IsDateString,
  IsNotEmpty,

...
export class MobileTestsService {
  ...
  async startTest(request, startTestDTO: StartTestDTO): Promise<any> {
      ...
      { uuid: request.user.uuid },
      {
        $addToSet: {
          "testSeriesSubmissions":  {
            testSeriesUuid: startTestDTO.testSeriesUuid,
            categoryUuid: startTestDTO.categoryUuid,
            courseId: startTestDTO.courseId,

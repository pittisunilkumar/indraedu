...
export class CreateSyllabusComponent implements OnInit, OnChanges {
  ...
  buildForm() {
    ...
    this.createSyllabusForm = this.formBuilder.group({
      title: [this.syllabusByUuid ? this.syllabusByUuid?.title : '', Validators.required],
      type: [this.syllabusByUuid ? this.syllabusByUuid?.type : '', Validators.required],
      shortcut: [this.syllabusByUuid ? this.syllabusByUuid?.shortcut : '', Validators.required],
      ...
      order:[ this.syllabusByUuid ? this.syllabusByUuid?.order : null,Validators.required],
      ...
      flags: this.formBuilder.group({
        ...
        editable: this.syllabusByUuid ? this.syllabusByUuid?.flags.editable : true,
        suggested: this.syllabusByUuid ? this.syllabusByUuid?.flags.suggested : true,
        testSeries: this.syllabusByUuid ? this.syllabusByUuid?.flags.testSeries : true,
        videos: this.syllabusByUuid ? this.syllabusByUuid?.flags.videos : true,
        materials: this.syllabusByUuid ? this.syllabusByUuid?.flags.materials : false,
        flashCards: this.syllabusByUuid ? this.syllabusByUuid?.flags.flashCards : false,
        questionBank: this.syllabusByUuid ? this.syllabusByUuid?.flags.questionBank : false,

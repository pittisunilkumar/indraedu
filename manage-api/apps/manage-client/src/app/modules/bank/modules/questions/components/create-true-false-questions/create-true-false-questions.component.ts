...
import { QuestionInterface, SyllabusInterface, TagInterface } from '@application/api-interfaces';
...
@Component({
  selector: 'application-create-true-false-questions',
  templateUrl: './create-true-false-questions.component.html',
  styleUrls: ['./create-true-false-questions.component.less']
})
export class CreateTrueFalseQuestionsComponent implements OnInit {

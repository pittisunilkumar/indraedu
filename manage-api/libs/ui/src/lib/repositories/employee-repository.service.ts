...
export class EmployeeRepositoryService {
  ...
  getEditEmployeeByUuid(uuid: string): Observable<ResponseInterface<EmployeeInterface>> {
    return this.http.get<ResponseInterface<EmployeeInterface>>(this.baseUrl + 'employee/edit/' + uuid);
  }

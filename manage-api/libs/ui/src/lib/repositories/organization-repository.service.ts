...
export class OrganizationRepositoryService {
  ...
  getActiveOrganizations(): Observable<any> {
    return this.http.get(this.baseUrl + 'organizations/active');
  }
  ...
  updateOrganization(payload: OrganizationInterface): Observable<any> {
    return this.http.put(this.baseUrl + 'organizations', payload);
  }

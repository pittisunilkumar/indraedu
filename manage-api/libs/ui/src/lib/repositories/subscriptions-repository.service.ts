...
export class SubscriptionsRepositoryService {
  ...
  getCouponSubscriptions(): Observable<ResponseInterface<SubscriptionInterface[]>> {
    return this.http.get<ResponseInterface<SubscriptionInterface[]>>(this.baseUrl + 'subscriptions/sub/couponSubscriptions');
  }

    ...
    return (host) => {
        ...
        return schematics_1.chain([
            ...
            workspace_1.updateJsonInTree(`${options.e2eProjectRoot}/tsconfig.json`, (json) => {
                return Object.assign(Object.assign({}, json), { extends: `${workspace_1.offsetFromRoot(options.e2eProjectRoot)}tsconfig.base.json` });
            }),
        ]);
    };
}
function addEditorTsConfigReference(options) {
    ...
    return schematics_1.chain([
        ...
        workspace_1.updateWorkspace((workspace) => {
            ...
            const isUsingTSLint = (lintTarget === null || lintTarget === void 0 ? void 0 : lintTarget.builder) === '@angular-devkit/build-angular:tslint';
            if (isUsingTSLint) {
                const tsConfigs = lintTarget.options.tsConfig;
                tsConfigs.push(core_1.join(core_1.normalize(options.appProjectRoot), 'tsconfig.editor.json'));
            }
        }),
    ]);
}
    ...
    return (host) => {
        ...
        const updateAngularWorkspace = workspace_1.updateWorkspace((workspace) => {
            ...
            workspace.extensions.schematics['@nrwl/angular:application'] =
                workspace.extensions.schematics['@nrwl/angular:application'] || {};
            workspace.extensions.schematics['@nrwl/angular:application'].strict = (_a = workspace.extensions.schematics['@nrwl/angular:application'].strict) !== null && _a !== void 0 ? _a : options.strict;
        });
